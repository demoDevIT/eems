class AddressInfoModal {
  int? state;
  bool? status;
  String? message;
  dynamic errorMessage;
  List<AddressInfoData>? data;

  AddressInfoModal(
      {this.state, this.status, this.message, this.errorMessage, this.data});

  AddressInfoModal.fromJson(Map<String, dynamic> json) {
    state = json['State'];
    status = json['Status'];
    ...
    if (json['Data'] != null) {
      ...
      json['Data'].forEach((v) {
        data!.add(new AddressInfoData.fromJson(v));
      });
    }
  }
...
class AddressInfoData {
  ...
  AddressInfoData.fromJson(Map<String, dynamic> json) {
