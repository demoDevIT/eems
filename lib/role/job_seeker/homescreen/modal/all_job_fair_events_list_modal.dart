class AllJobFairEventsListModal {
  dynamic state;
  bool? status;
  dynamic message;
  dynamic errorMessage;
  List<AllJobFairEventsData>? data;

  AllJobFairEventsListModal(
      {this.state, this.status, this.message, this.errorMessage, this.data});

  AllJobFairEventsListModal.fromJson(Map<String, dynamic> json) {
    state = json['State'];
    status = json['Status'];
    message = json['Message'];
    errorMessage = json['ErrorMessage'];
    if (json['Data'] != null) {
      data = <AllJobFairEventsData>[];
      json['Data'].forEach((v) {
        data!.add(new AllJobFairEventsData.fromJson(v));
      });
    }
  }
...
class AllJobFairEventsData {
  ...
  AllJobFairEventsData.fromJson(Map<String, dynamic> json) {
