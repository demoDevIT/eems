                        ...
                        children: [
                                ...
                                child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                          provider.grievanceDataList[index].createdBy.toString(),
                                          style: Styles
                                              .regularTextStyle(
                                              size: 12,
                                              color: kBlackColor),
                                ...
                                child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                          provider.grievanceDataList[index].remark.toString(),
                                          style: Styles
                                              .regularTextStyle(
                                              size: 12,
                                              color: kBlackColor),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                 String url = provider.grievanceDataList[index].fileAttachment.toString();
                                 print(url.toString());
                                },
                                child: Container(
                                  alignment:
