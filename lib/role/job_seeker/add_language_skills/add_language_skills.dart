...
class AddLanguageSkillsScreen extends StatefulWidget {
  ...
  bool showSkillSection;
  bool showLanguageSection;

  ProfileSkillInfoData? profileSkillInfoData;
  ProfileLanguageInfoData? profileLanguageInfoData;

  AddLanguageSkillsScreen(
      {super.key,
      required this.isUpdateSkill,
      required this.isUpdateLanguage,
      required this.profileSkillInfoData,
      required this.profileLanguageInfoData,
      required this.showSkillSection,
      required this.showLanguageSection});

  @override
  State<AddLanguageSkillsScreen> createState() => _AddLanguageSkillsScreenState(
      isUpdateSkill,
      isUpdateLanguage,
...
class _AddLanguageSkillsScreenState extends State<AddLanguageSkillsScreen> {
  ...
  _AddLanguageSkillsScreenState(this.isUpdateSkill, this.isUpdateLanguage,
      this.profileSkillInfoData, this.profileLanguageInfoData);

  late bool showSkillSection;
  late bool showLanguageSection;
  ...
  void initState() {
    ...
    showSkillSection = widget.showSkillSection;
    showLanguageSection = widget.showLanguageSection;

    SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
      final provider =
          Provider.of<AddLanguageSkillsProvider>(context, listen: false);
      provider.clearData();
      provider.ncoCodeApi(context, isUpdateSkill, isUpdateLanguage,
          profileSkillInfoData, profileLanguageInfoData);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: commonAppBar2(
            screenTitle, context, localeProvider.currentLanguage, "", false, "",
            onTapClick: () {
        ...
        bottomNavigationBar: Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                if (validateSkillAndLanguageForm(
                  context,
                  provider,
                    ...
                    (value) {
                      if (value.toString() == "success") {
                        /* =======================
                         ...
                         ======================= */
                        if (showSkillSection) {
                          provider.saveSkillsApi(
                            context,
                            isUpdateSkill,
                            isUpdateLanguage,
                            isUpdateSkill && profileSkillInfoData != null
                                ? profileSkillInfoData!.skillDetailID.toString()
                                : "",
                            "",
                          );
                        }
                        ...
                        /* =======================
                         ...
                         ======================= */
                        else if (showLanguageSection) {
                          provider.saveDataLanguageApi(
                            context,
                            isUpdateSkill,
                            isUpdateLanguage,
                            isUpdateLanguage && profileLanguageInfoData != null
                                ? profileLanguageInfoData!.languageDetailID
                                    .toString()
                                : "",
                          );
                        }

                        // if (isUpdateSkill == false &&
                        //     isUpdateLanguage == false) {
                        //   provider.saveSkillsApi(
                        //       context, isUpdateSkill, isUpdateLanguage, "", "");
                        ...
                        //           ? profileSkillInfoData!.skillDetailID
                        //               .toString()
                        //           : "",
                        //       "");
        ...
        body: Consumer<AddLanguageSkillsProvider>(
  ...
  bool validateSkillAndLanguageForm(
    BuildContext context,
    provider, {
    required bool showSkillSection,
    required bool showLanguageSection,
  }) {
    if (showSkillSection) {
      // ---------- CATEGORY ----------
