...
import 'dept_basic_detail.dart';

class DeptProfileScreen extends StatefulWidget {
  bool isAppBarHide;
  DeptProfileScreen({super.key, required this.isAppBarHide});

  @override
  State<DeptProfileScreen> createState() => _DeptProfileScreenState();
}

class _DeptProfileScreenState extends State<DeptProfileScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Consumer<DeptProfileProvider>(builder: (context, provider, child) {
          return   SingleChildScrollView(
            padding: const EdgeInsets.all(16),
            child: Column(
              children: [
                /// Dept Profile Section
                // Padding(
      ...
      child: ListTile(
        ...
        onTap: () {
          if (title == "Basic Details") {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DeptBasicDetailsScreen()),
            );
          }
